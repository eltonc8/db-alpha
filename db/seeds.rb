...
SecurityList.create!(name: "Standard & Poor 500", symbol: "S&P500", securities: [
  ...
  "TRTR", "TRV", "TSCO", "TSN", "TSO", "TSS", "TWC", "TWXTWXN", "TXT", "TYC",
  "UA", "UAL", "UHS", "UNH", "UNM", "UNP", "UPS", "URBN", "URI", "USB",
  "UUU", "V", "VAR", "VFC", "VIAB", "VLO", "VMC", "VNO", "VRSN", "VRTV",
  "VTR", "VZ", "WAT", "WBA", "WDC", "WEC", "WFC", "WFM", "WHR", "WM",
  "WMB", "WMT", "WRK", "WU", "WY", "WYN", "WYNN", "XEC", "XEL", "XL",
